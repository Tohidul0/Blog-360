...
function Header(props) {
  ...
  return (
    <Navbar className="border-b-2  px-6">
      <Link
        to="/"
        className="white-space: nowrap text-sm sm:text-xl font-semibold"
      >
        ...
        {currentUser ? (
          ...
          >
            <DropdownHeader>
              ...
              <span className="block text-medium font-semibold">
                {currentUser.email}
              </span>
            </DropdownHeader>
            <DropdownItem>
            ...
            <DropdownItem>
              <Link onClick={gotoSignOut} className="font-semibold">
                Sign Out
              </Link>
            </DropdownItem>
          </Dropdown>
          ...
          <>
            <Link to="/Login">
              <button className="bg-gradient-to-r hover:opacity-80 from-blue-500 to-green-500 text-white font-bold py-2 px-4 rounded">
                Log In
              </button>
            </Link>
            <Link to="/register">
