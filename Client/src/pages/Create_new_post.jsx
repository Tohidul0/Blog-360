    ...
    <div className="min-h-screen pt-10">
      ...
      <form onSubmit={hendleSubmit}>
        ...
        <TextInput
          ...
          id="title"
          placeholder="Title"
          className="sm:w-full md:w-3/5 mx-auto mt-5"
          onBlur={(e) =>
        ...
        <div className="sm:w-full md:w-3/5 mx-auto">
          <textarea
            ...
            name="comment"
            rows="4"
            className=" w-full mx-auto  border rounded-md  mt-5 bg-gray-700 text-white leading-tight"
          ></textarea>
        </div>
        <Button
          type="submit"
          className="sm:w-full md:w-3/5 mx-auto mt-5 bg-gradient-to-r from-blue-500 to-green-500"
        >
          Post
        </Button>
      </form>
